...
?>
</div><form name="search" method="post" ><tr><form name="search" method="post" >
<h1 style="text-align: center;"><font color="1168a6"><font size="6"><font face="Tahoma, Geneva, sans-serif"> </font></font></font></h1>
<p style="text-align: center;"><input maxlength="50" name="query" size="50" type="search" placeholder="Введите ник или любой текст" /></p>
...
<div class="boxtitle">Логи чата</div></td>
<?php
require_once("includes/logs.php");
mysqli_query($con,"SET NAMES 'utf8'");
$name=$_POST['query']; 
$result=mysqli_query($con,"SELECT * FROM  `logs_chat` WHERE `action` LIKE '%" . $name . "%' ORDER BY date DESC LIMIT 0,1000");
